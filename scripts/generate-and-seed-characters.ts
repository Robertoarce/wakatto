...
const characters = [
  ...
  { id: 'handsome_hope_president', name: 'Handsome Hope President', role: 'President', desc: '44th US President, hope and change', traits: [9,7,7,8,7,9,9,8], style: 'positive', resp: 'inspiring' },
