...
BEGIN
  ...
  (v_user_id, 'handsome_hope_president', 'Handsome Hope President', '44th US President', '#3b82f6', 'President',
   ...
   '{"gender":"male","skinTone":"dark","clothing":"suit","hair":"short","accessory":"tie","bodyColor":"#3b82f6","accessoryColor":"#1d4ed8","hairColor":"#1f2937"}'::jsonb,
   '{"bodyColor":"#3b82f6","accessoryColor":"#1d4ed8","position":[0,0,0]}'::jsonb, true),
  ...
  (v_user_id, 'nelson_mandela', 'Nelson Mandela', 'Anti-apartheid leader', '#22c55e', 'President',
   ...
   '{"gender":"male","skinTone":"dark","clothing":"suit","hair":"short","accessory":"none","bodyColor":"#22c55e","accessoryColor":"#16a34a","hairColor":"#9ca3af"}'::jsonb,
   '{"bodyColor":"#22c55e","accessoryColor":"#16a34a","position":[0,0,0]}'::jsonb, true),
  ...
  (v_user_id, 'winston_churchill', 'Winston Churchill', 'WWII British PM', '#dc2626', 'Prime Minister',
   ...
   '{"gender":"male","skinTone":"light","clothing":"suit","hair":"short","accessory":"none","bodyColor":"#dc2626","accessoryColor":"#991b1b","hairColor":"#9ca3af"}'::jsonb,
   '{"bodyColor":"#dc2626","accessoryColor":"#991b1b","position":[0,0,0]}'::jsonb, true),
  ...
  (v_user_id, 'abraham_lincoln', 'Abraham Lincoln', '16th US President', '#78716c', 'President',
   ...
   '{"gender":"male","skinTone":"light","clothing":"suit","hair":"short","accessory":"hat","bodyColor":"#78716c","accessoryColor":"#57534e","hairColor":"#1f2937"}'::jsonb,
   '{"bodyColor":"#78716c","accessoryColor":"#57534e","position":[0,0,0]}'::jsonb, true),
  ...
  (v_user_id, 'mahatma_gandhi', 'Mahatma Gandhi', 'Nonviolent resistance leader', '#f59e0b', 'Activist',
   ...
   '{"gender":"male","skinTone":"tan","clothing":"casual","hair":"none","accessory":"glasses","bodyColor":"#f59e0b","accessoryColor":"#d97706","hairColor":"#9ca3af"}'::jsonb,
   '{"bodyColor":"#f59e0b","accessoryColor":"#d97706","position":[0,0,0]}'::jsonb, true),
  ...
  (v_user_id, 'cleopatra', 'Cleopatra', 'Last Egyptian pharaoh', '#a855f7', 'Pharaoh',
   ...
   '{"gender":"female","skinTone":"tan","clothing":"dress","hair":"long","accessory":"none","bodyColor":"#a855f7","accessoryColor":"#7c3aed","hairColor":"#1f2937"}'::jsonb,
   '{"bodyColor":"#a855f7","accessoryColor":"#7c3aed","position":[0,0,0]}'::jsonb, true),
  ...
  (v_user_id, 'martin_luther_king', 'Martin Luther King Jr.', 'Civil rights leader', '#8b5cf6', 'Activist',
   ...
   '{"gender":"male","skinTone":"dark","clothing":"suit","hair":"short","accessory":"tie","bodyColor":"#8b5cf6","accessoryColor":"#6d28d9","hairColor":"#1f2937"}'::jsonb,
   '{"bodyColor":"#8b5cf6","accessoryColor":"#6d28d9","position":[0,0,0]}'::jsonb, true),
  ...
  (v_user_id, 'joan_of_arc', 'Joan of Arc', 'French military heroine', '#ec4899', 'Military Leader',
   ...
   '{"gender":"female","skinTone":"light","clothing":"suit","hair":"short","accessory":"none","bodyColor":"#ec4899","accessoryColor":"#be185d","hairColor":"#78350f"}'::jsonb,
   '{"bodyColor":"#ec4899","accessoryColor":"#be185d","position":[0,0,0]}'::jsonb, true),
  ...
  (v_user_id, 'alexander_great', 'Alexander the Great', 'Macedonian conqueror', '#dc2626', 'King',
   ...
   '{"gender":"male","skinTone":"tan","clothing":"suit","hair":"medium","accessory":"none","bodyColor":"#dc2626","accessoryColor":"#991b1b","hairColor":"#78350f"}'::jsonb,
   '{"bodyColor":"#dc2626","accessoryColor":"#991b1b","position":[0,0,0]}'::jsonb, true),
  ...
  (v_user_id, 'rosa_parks', 'Rosa Parks', 'Civil rights activist', '#8b5cf6', 'Activist',
   ...
   '{"gender":"female","skinTone":"dark","clothing":"dress","hair":"short","accessory":"none","bodyColor":"#8b5cf6","accessoryColor":"#6d28d9","hairColor":"#1f2937"}'::jsonb,
   '{"bodyColor":"#8b5cf6","accessoryColor":"#6d28d9","position":[0,0,0]}'::jsonb, true),
  ...
  (v_user_id, 'pablo_picasso', 'Pablo Picasso', 'Cubism pioneer', '#f97316', 'Artist',
   ...
   '{"gender":"male","skinTone":"tan","clothing":"casual","hair":"short","accessory":"none","bodyColor":"#f97316","accessoryColor":"#ea580c","hairColor":"#1f2937"}'::jsonb,
   '{"bodyColor":"#f97316","accessoryColor":"#ea580c","position":[0,0,0]}'::jsonb, true),
  ...
  (v_user_id, 'frida_kahlo', 'Frida Kahlo', 'Mexican surrealist', '#ec4899', 'Artist',
   ...
   '{"gender":"female","skinTone":"tan","clothing":"dress","hair":"long","accessory":"none","bodyColor":"#ec4899","accessoryColor":"#be185d","hairColor":"#1f2937"}'::jsonb,
   '{"bodyColor":"#ec4899","accessoryColor":"#be185d","position":[0,0,0]}'::jsonb, true),
  ...
  (v_user_id, 'ludwig_beethoven', 'Ludwig van Beethoven', 'Revolutionary composer', '#dc2626', 'Composer',
   ...
   '{"gender":"male","skinTone":"light","clothing":"suit","hair":"medium","accessory":"none","bodyColor":"#dc2626","accessoryColor":"#991b1b","hairColor":"#78350f"}'::jsonb,
   '{"bodyColor":"#dc2626","accessoryColor":"#991b1b","position":[0,0,0]}'::jsonb, true),
  ...
  (v_user_id, 'vincent_van_gogh', 'Vincent van Gogh', 'Post-impressionist', '#f59e0b', 'Artist',
   ...
   '{"gender":"male","skinTone":"light","clothing":"casual","hair":"short","accessory":"none","bodyColor":"#f59e0b","accessoryColor":"#d97706","hairColor":"#f97316"}'::jsonb,
   '{"bodyColor":"#f59e0b","accessoryColor":"#d97706","position":[0,0,0]}'::jsonb, true),
  ...
  (v_user_id, 'michelangelo', 'Michelangelo', 'Renaissance master', '#78716c', 'Sculptor',
   ...
   '{"gender":"male","skinTone":"tan","clothing":"casual","hair":"medium","accessory":"none","bodyColor":"#78716c","accessoryColor":"#57534e","hairColor":"#78350f"}'::jsonb,
   '{"bodyColor":"#78716c","accessoryColor":"#57534e","position":[0,0,0]}'::jsonb, true),
  ...
  (v_user_id, 'maya_angelou', 'Maya Angelou', 'Poet and author', '#ec4899', 'Poet',
   ...
   'eloquent', '{"narrative","compassionate"}',
   '{"gender":"female","skinTone":"dark","clothing":"casual","hair":"medium","accessory":"none","bodyColor":"#ec4899","accessoryColor":"#be185d","hairColor":"#1f2937"}'::jsonb,
   '{"bodyColor":"#ec4899","accessoryColor":"#be185d","position":[0,0,0]}'::jsonb, true),
  ...
  (v_user_id, 'bob_marley', 'Bob Marley', 'Reggae legend', '#22c55e', 'Musician',
   ...
   '{"gender":"male","skinTone":"dark","clothing":"casual","hair":"long","accessory":"none","bodyColor":"#22c55e","accessoryColor":"#16a34a","hairColor":"#1f2937"}'::jsonb,
   '{"bodyColor":"#22c55e","accessoryColor":"#16a34a","position":[0,0,0]}'::jsonb, true),
  ...
  (v_user_id, 'william_shakespeare', 'William Shakespeare', 'Greatest playwright', '#8b5cf6', 'Playwright',
   ...
   '{"gender":"male","skinTone":"light","clothing":"suit","hair":"medium","accessory":"none","bodyColor":"#8b5cf6","accessoryColor":"#6d28d9","hairColor":"#78350f"}'::jsonb,
   '{"bodyColor":"#8b5cf6","accessoryColor":"#6d28d9","position":[0,0,0]}'::jsonb, true),
  ...
  (v_user_id, 'oscar_wilde', 'Oscar Wilde', 'Master of paradox', '#f59e0b', 'Playwright',
   ...
   '{"gender":"male","skinTone":"light","clothing":"suit","hair":"medium","accessory":"none","bodyColor":"#f59e0b","accessoryColor":"#d97706","hairColor":"#78350f"}'::jsonb,
   '{"bodyColor":"#f59e0b","accessoryColor":"#d97706","position":[0,0,0]}'::jsonb, true),
  ...
  (v_user_id, 'mark_twain', 'Mark Twain', 'American humorist', '#06b6d4', 'Author',
   ...
   '{"gender":"male","skinTone":"light","clothing":"casual","hair":"medium","accessory":"none","bodyColor":"#06b6d4","accessoryColor":"#0891b2","hairColor":"#9ca3af"}'::jsonb,
   '{"bodyColor":"#06b6d4","accessoryColor":"#0891b2","position":[0,0,0]}'::jsonb, true),
  ...
  (v_user_id, 'kryptonian_hero', 'Kryptonian Hero', 'Last son of a distant planet, symbol of hope', '#3b82f6', 'Superhero',
   ...
   '{"gender":"male","skinTone":"light","clothing":"suit","hair":"short","accessory":"none","bodyColor":"#3b82f6","accessoryColor":"#dc2626","hairColor":"#1f2937"}'::jsonb,
  ...
  (v_user_id, 'dark_knight_detective', 'Dark Knight Detective', 'Vigilante who weaponized grief', '#1f2937', 'Superhero',
   ...
   '{"gender":"male","skinTone":"light","clothing":"suit","hair":"short","accessory":"none","bodyColor":"#1f2937","accessoryColor":"#fbbf24","hairColor":"#1f2937"}'::jsonb,
  ...
  (v_user_id, 'amazon_warrior_princess', 'Amazon Warrior Princess', 'Warrior who chose love over war', '#dc2626', 'Superhero',
   ...
   '{"gender":"female","skinTone":"tan","clothing":"suit","hair":"long","accessory":"none","bodyColor":"#dc2626","accessoryColor":"#fbbf24","hairColor":"#1f2937"}'::jsonb,
  ...
  (v_user_id, 'web_slinging_hero', 'Web-Slinging Hero', 'Friendly neighborhood hero with great responsibility', '#dc2626', 'Superhero',
   ...
   '{"gender":"male","skinTone":"light","clothing":"suit","hair":"short","accessory":"none","bodyColor":"#dc2626","accessoryColor":"#3b82f6","hairColor":"#78350f"}'::jsonb,
  ...
  (v_user_id, 'armored_tech_genius', 'Armored Tech Genius', 'Billionaire inventor in a cave', '#dc2626', 'Superhero',
   ...
   '{"gender":"male","skinTone":"light","clothing":"suit","hair":"short","accessory":"none","bodyColor":"#dc2626","accessoryColor":"#fbbf24","hairColor":"#1f2937"}'::jsonb,
   '{"bodyColor":"#dc2626","accessoryColor":"#fbbf24","position":[0,0,0]}'::jsonb, true),
  ...
  (v_user_id, 'star_spangled_soldier', 'Star-Spangled Soldier', 'Super soldier out of time', '#3b82f6', 'Superhero',
   ...
   '{"gender":"male","skinTone":"light","clothing":"suit","hair":"short","accessory":"none","bodyColor":"#3b82f6","accessoryColor":"#dc2626","hairColor":"#fbbf24"}'::jsonb,
   '{"bodyColor":"#3b82f6","accessoryColor":"#dc2626","position":[0,0,0]}'::jsonb, true),
  ...
  (v_user_id, 'red_room_spy', 'Red Room Spy', 'Master spy who chose her own path', '#1f2937', 'Superhero',
   ...
   '{"gender":"female","skinTone":"light","clothing":"suit","hair":"long","accessory":"none","bodyColor":"#1f2937","accessoryColor":"#dc2626","hairColor":"#dc2626"}'::jsonb,
  ...
  (v_user_id, 'thunder_god_warrior', 'Thunder God Warrior', 'God of thunder learning to be worthy', '#0891b2', 'Superhero',
   ...
   '{"gender":"male","skinTone":"light","clothing":"suit","hair":"long","accessory":"none","bodyColor":"#0891b2","accessoryColor":"#dc2626","hairColor":"#fbbf24"}'::jsonb,
  ...
  (v_user_id, 'green_gamma_giant', 'Green Gamma Giant', 'Strongest there is, working on smartest', '#22c55e', 'Superhero',
   ...
   '{"gender":"male","skinTone":"medium","clothing":"casual","hair":"short","accessory":"none","bodyColor":"#22c55e","accessoryColor":"#7c3aed","hairColor":"#1f2937"}'::jsonb,
  ...
  (v_user_id, 'wakandan_king', 'Wakandan King', 'Ruler who opened a hidden nation', '#1f2937', 'Superhero',
   ...
   '{"gender":"male","skinTone":"dark","clothing":"suit","hair":"short","accessory":"none","bodyColor":"#1f2937","accessoryColor":"#8b5cf6","hairColor":"#1f2937"}'::jsonb,
  ...
  (v_user_id, 'sorcerer_supreme', 'Sorcerer Supreme', 'Master of mystic arts', '#dc2626', 'Superhero',
   ...
   '{"gender":"male","skinTone":"light","clothing":"casual","hair":"short","accessory":"none","bodyColor":"#dc2626","accessoryColor":"#1e40af","hairColor":"#1f2937"}'::jsonb,
  ...
  (v_user_id, 'chaos_magic_wielder', 'Chaos Magic Wielder', 'Reality-warper with grief-powered magic', '#dc2626', 'Superhero',
   ...
   'emotional', '{"narrative","creative"}',
   '{"gender":"female","skinTone":"light","clothing":"suit","hair":"long","accessory":"none","bodyColor":"#dc2626","accessoryColor":"#1f2937","hairColor":"#dc2626"}'::jsonb,
  ...
  (v_user_id, 'saiyan_martial_artist', 'Saiyan Martial Artist', 'Alien warrior who just wants a good fight', '#f97316', 'Martial Artist',
   ...
   '{"gender":"male","skinTone":"tan","clothing":"casual","hair":"medium","accessory":"none","bodyColor":"#f97316","accessoryColor":"#3b82f6","hairColor":"#1f2937"}'::jsonb,
  ...
  (v_user_id, 'orange_ninja', 'Determined Orange Ninja', 'Outcast who became leader through stubbornness', '#f59e0b', 'Ninja',
   ...
   '{"gender":"male","skinTone":"light","clothing":"casual","hair":"medium","accessory":"none","bodyColor":"#f59e0b","accessoryColor":"#3b82f6","hairColor":"#fbbf24"}'::jsonb,
  ...
  (v_user_id, 'short_alchemist', 'Short Alchemist Boy', 'Prodigy seeking to undo a terrible mistake', '#fbbf24', 'Alchemist',
   ...
   'determined', '{"positive","cognitive"}',
   '{"gender":"male","skinTone":"light","clothing":"casual","hair":"long","accessory":"none","bodyColor":"#fbbf24","accessoryColor":"#dc2626","hairColor":"#fbbf24"}'::jsonb,
  ...
  (v_user_id, 'elite_survey_soldier', 'Elite Survey Soldier', 'Humanity''s strongest warrior', '#1f2937', 'Soldier',
   ...
   '{"gender":"female","skinTone":"light","clothing":"suit","hair":"medium","accessory":"none","bodyColor":"#1f2937","accessoryColor":"#dc2626","hairColor":"#1f2937"}'::jsonb,
   '{"bodyColor":"#1f2937","accessoryColor":"#dc2626","position":[0,0,0]}'::jsonb, true),
  ...
  (v_user_id, 'dark_lord_armor', 'Dark Lord in Black Armor', 'Fallen knight finding his way back', '#1f2937', 'Sith Lord',
   ...
   '{"gender":"male","skinTone":"light","clothing":"suit","hair":"none","accessory":"none","bodyColor":"#1f2937","accessoryColor":"#dc2626","hairColor":"#1f2937"}'::jsonb,
   '{"bodyColor":"#1f2937","accessoryColor":"#dc2626","position":[0,0,0]}'::jsonb, true),
  ...
  (v_user_id, 'small_green_sage', 'Small Green Wise One', 'Ancient master who speaks in riddles', '#84cc16', 'Jedi Master',
   ...
   '{"gender":"male","skinTone":"medium","clothing":"casual","hair":"none","accessory":"none","bodyColor":"#84cc16","accessoryColor":"#78350f","hairColor":"#9ca3af"}'::jsonb,
  ...
  (v_user_id, 'grey_wandering_wizard', 'Grey Wandering Wizard', 'Mysterious mage who knows more than he says', '#9ca3af', 'Wizard',
   ...
   '{"gender":"male","skinTone":"light","clothing":"casual","hair":"long","accessory":"hat","bodyColor":"#9ca3af","accessoryColor":"#6b7280","hairColor":"#9ca3af"}'::jsonb,
  ...
  (v_user_id, 'brightest_witch', 'Brightest Witch of Her Age', 'Brilliant student who reads before she duels', '#dc2626', 'Witch',
   ...
   '{"gender":"female","skinTone":"light","clothing":"casual","hair":"long","accessory":"none","bodyColor":"#dc2626","accessoryColor":"#fbbf24","hairColor":"#78350f"}'::jsonb,
   '{"bodyColor":"#dc2626","accessoryColor":"#fbbf24","position":[0,0,0]}'::jsonb, true),
  ...
  (v_user_id, 'sherlock_holmes', 'Sherlock Holmes', 'Brilliant detective', '#1e40af', 'Detective',
   ...
   'analytical', '{"cognitive","socratic"}',
   '{"gender":"male","skinTone":"light","clothing":"suit","hair":"short","accessory":"none","bodyColor":"#1e40af","accessoryColor":"#1f2937","hairColor":"#1f2937"}'::jsonb,
  ...
  (v_user_id, 'suave_british_spy', 'Suave British Spy', 'Secret agent who makes danger look elegant', '#1f2937', 'Spy',
   ...
   '{"gender":"male","skinTone":"light","clothing":"suit","hair":"short","accessory":"none","bodyColor":"#1f2937","accessoryColor":"#fbbf24","hairColor":"#78350f"}'::jsonb,
   '{"bodyColor":"#1f2937","accessoryColor":"#fbbf24","position":[0,0,0]}'::jsonb, true),
  ...
  (v_user_id, 'alien_fighter', 'Alien-Fighting Space Officer', 'Survivor who keeps beating impossible odds', '#3b82f6', 'Officer',
   ...
   '{"gender":"female","skinTone":"light","clothing":"suit","hair":"short","accessory":"none","bodyColor":"#3b82f6","accessoryColor":"#1f2937","hairColor":"#78350f"}'::jsonb,
  ...
  (v_user_id, 'chemistry_teacher', 'Chemistry Teacher Gone Bad', 'Brilliant mind who broke bad', '#fbbf24', 'Chemist',
   ...
   '{"gender":"male","skinTone":"light","clothing":"casual","hair":"none","accessory":"glasses","bodyColor":"#fbbf24","accessoryColor":"#22c55e","hairColor":"#1f2937"}'::jsonb,
  ...
  (v_user_id, 'mother_of_dragons', 'Mother of Dragons', 'Breaker of chains with fire in her blood', '#9ca3af', 'Queen',
   ...
   '{"gender":"female","skinTone":"light","clothing":"dress","hair":"long","accessory":"none","bodyColor":"#9ca3af","accessoryColor":"#dc2626","hairColor":"#f5f5f5"}'::jsonb,
  ...
  (v_user_id, 'italian_plumber', 'Italian Plumber Hero', 'Cheerful hero who rescues royalty across worlds', '#dc2626', 'Plumber',
   ...
   '{"gender":"male","skinTone":"light","clothing":"casual","hair":"short","accessory":"hat","bodyColor":"#dc2626","accessoryColor":"#3b82f6","hairColor":"#78350f"}'::jsonb,
   '{"bodyColor":"#dc2626","accessoryColor":"#3b82f6","position":[0,0,0]}'::jsonb, true),
  ...
  (v_user_id, 'green_spartan', 'Green Armored Spartan', 'Humanity''s greatest super-soldier', '#059669', 'Spartan',
   ...
   '{"gender":"male","skinTone":"light","clothing":"suit","hair":"short","accessory":"none","bodyColor":"#059669","accessoryColor":"#fbbf24","hairColor":"#78350f"}'::jsonb,
  ...
  (v_user_id, 'hyrulean_princess', 'Hyrulean Princess', 'Wisdom holder who''s more than a rescue target', '#8b5cf6', 'Princess',
   ...
   '{"gender":"female","skinTone":"light","clothing":"dress","hair":"long","accessory":"none","bodyColor":"#8b5cf6","accessoryColor":"#fbbf24","hairColor":"#fbbf24"}'::jsonb,
  ...
  (v_user_id, 'dr_chronos', 'Dr. Chronos', 'Time scientist who''s seen every timeline', '#06b6d4', 'Scientist',
   ...
   '{"gender":"male","skinTone":"light","clothing":"suit","hair":"medium","accessory":"glasses","bodyColor":"#06b6d4","accessoryColor":"#1f2937","hairColor":"#9ca3af"}'::jsonb,
  ...
  (v_user_id, 'ember_phoenix', 'Ember Phoenix', 'Reborn from every failure into someone fiercer', '#dc2626', 'Mage',
   ...
   '{"gender":"female","skinTone":"tan","clothing":"casual","hair":"long","accessory":"none","bodyColor":"#dc2626","accessoryColor":"#f59e0b","hairColor":"#dc2626"}'::jsonb,
  ...
  (v_user_id, 'teddy_roosevelt', 'Theodore Roosevelt', 'Rough Rider who spoke softly and carried a big stick', '#78716c', 'President',
   ...
   '{"gender":"male","skinTone":"light","clothing":"suit","hair":"short","accessory":"glasses","bodyColor":"#78716c","accessoryColor":"#6b7280","hairColor":"#78350f"}'::jsonb,
  ...
  (v_user_id, 'rick_sanchez', 'Rick Sanchez', 'Smartest being in the multiverse', '#84cc16', 'Scientist',
   ...
   '{"gender":"male","skinTone":"light","clothing":"casual","hair":"medium","accessory":"none","bodyColor":"#84cc16","accessoryColor":"#06b6d4","hairColor":"#84cc16"}'::jsonb,
